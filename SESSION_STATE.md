...
## 2026-05-10 항공/숙소 최신 반영

- 항공:
  - 출국: Eastar `ZE593`, 2026-07-24 20:35 인천 출발, 23:25 다낭 도착
  - 귀국: Eastar `ZE594`, 2026-07-29 00:25 다낭 출발, 06:55 인천 도착
- 일정 방향:
  - 시내 일정은 7/25 토요일 체크아웃 후 Hyatt 이동 전, 7/28 화요일 Hyatt 체크아웃 후 공항 이동 전 중심이다.
  - 7/29 수요일은 현지 관광일이 아니라 귀국 항공 이동일이다.
- 숙소:
  - New Orient Hotel은 도착 0.5박 회복 숙소로 유지.
  - Hyatt Regency Danang Resort & Spa는 7/25-7/28 메인 리조트로 유지.
  - Happy Day Hotel은 마지막 0.5박 후보지만 사용자가 마음에 들지 않는다고 했으므로 `재검토` 상태로 낮췄다.
  - HAIAN Riverfront, Avora, Val Soleil, Novotel Han River, Courtyard by Marriott Han River를 대체 후보로 추가했다.
- 숙소 탭:
  - 숙소 후보 지도 추가.
  - 확정 숙소와 0.5박 후보, 상향 후보를 지도에서 분리 표시.
  - 호텔 추천 카드에 최신 후기 신호와 후기 주의 신호를 추가.
